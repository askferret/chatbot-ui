...
AS $$
DECLARE
  project_url TEXT := 'https://buoccnyyqckorlxicrqd.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJ1b2Njbnl5cWNrb3JseGljcnFkIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0ODEzMzUxNCwiZXhwIjoyMDYzNzA5NTE0fQ.Nx92nbHIkmecFw017QY_NAoIFC6ohPaAIsyJf9DyMyY'; -- full access needed for http request to storage
